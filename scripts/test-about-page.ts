...
assert.match(page, /<CommunityPhotos/);
assert.match(homeAbout, /<CommunityPhotos/);
assert.ok(existsSync(new URL("../public/images/lifestyle/hero-collage/family-03.png", import.meta.url)));
