...
for (const token of ["business.address.street", "business.address.cityStateZip", "business.phone.href", "business.hours", "business.directionsUrl", "business.orderInfoPath"]) assert.ok(page.includes(token), token);
...
for (const token of ["business.address.street", "business.phone.href", "business.hours", "business.directionsUrl", "business.orderInfoPath"]) assert.ok(homeVisit.includes(token), token);
